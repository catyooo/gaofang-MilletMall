      ...
      <div class="section section-address">
        ...
        <div class="section-body clearfix" id="J_addressList">
          <c:forEach items="${addresses}" var="address">
            <div class="address-item J_addressItem" data-address_id="${address.addressId}" data-consignee="${address.userName}" data-tel="${address.userPhone}" data-zipcode="${address.userZipcode}" data-address="${address.userAdress}" data-tag_name="${address.userTag}">
              <dl>
        ...
        <div class="money-box" id="J_moneyBox">
          <ul>
            ...
            <li class="clearfix total-price">
              <label>应付总额：</label>
              <span class="val"><em data-id="J_totalPrice">${cart.totalPrice}</em>元</span> </li>
          </ul>
        </div>
      </div>
