  ...
  <div class="container-fluid">
    <div class="buy-succ-box clearfix">
      <div class="goods-content" id="J_goodsBox">
        <div class="goods-img"> <a href="${ctx}/detail/${product.productNumber}"><img src="${ctximg}/${product.picImg}" title="${product.name}" width="110" height="110"> </a></div>
        <div class="goods-info"> <span class="name">${product.name}
          <h3>已成功加入购物车！</h3>
        </div>
      </div>
