            ...
            <div class="row">
              <div class="span4 span-first">
                <ul class="brick-promo-list clearfix">
                    <li class="brick-item2 brick-item-m" data-gid="${categoryAdvert.categoryAdvertId}"> 
                    <a title="${categoryAdvert.title}" href="${categoryAdvert.href}" target="_blank">
                    <img src="${ctximg}/images/advert/20170228/1471798364441.jpg" alt="广告"></a> </li>
                </ul>
              </div>
              <div class="span16">
